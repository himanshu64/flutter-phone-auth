...
class PinEntryTextField extends StatefulWidget {
  ...
  final Color cursorColor;  // Leaving the data type dynamic for adding Color or Material Color
...
class PinEntryTextFieldState extends State<PinEntryTextField> {
  ...
  void initState() {
   ...
   _pin=  List<String>.generate(widget.fields, (int index) => '');
    ...
    _textControllers =  List<TextEditingController>.generate(widget.fields, (int index) => TextEditingController());
