...
import 'package:flutter_phone_auth/presentation/widgets/countdown_timer.dart';
...
class _SignInVerificationViewState extends State<SignInVerificationView> with TickerProviderStateMixin {
                ...
                widget.delayBeforeNewCode > 0
                    ...
                    : InkWell(
                        ...
                        child: Container(
                          ...
                          decoration: BoxDecoration(
                              border:
                                  Border.all(width: 1, color: colorSecondary),
